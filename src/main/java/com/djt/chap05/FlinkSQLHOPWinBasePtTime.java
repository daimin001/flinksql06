 ...
 * FlinkSQL基于处理时间的滑动窗口
 */
public class FlinkSQLHOPWinBasePtTime {
    public static void main(String[] args) throws Exception {
        ...
        Table result = tEnv.sqlQuery("select " +
                "sensorID," +
                "count(sensorID)," +
                "HOP_START(ptTime, INTERVAL '2' second,INTERVAL '4' second) as winstart " +
                "from "+table+" GROUP BY sensorID,HOP(ptTime, INTERVAL '2' second,INTERVAL '4' second)");
