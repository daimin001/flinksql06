 ...
 * 标量函数使用
 */
public class FlinkParameterizableScalarFunction {
    public static void main(String[] args) {
        ...
        //tEnv.from("MyTable").select(call(SubstringFunction.class, $("myField"), 5, 13));
        tEnv.from("users").select(call(new SubstringFunction(true), $("introduction"), 5, 13))
                .execute()
                .print();
        ...
        tEnv.createTemporarySystemFunction("SubstringFunction", new SubstringFunction(true));
